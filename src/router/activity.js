...
export default [
    ...
    // 火币信息
    {
        ...
        name: "huobiInfo",
        component: () =>
            import ( /* webpackChunkName: 'redEnvelopeRain' */ "@/views/activity/huobiInfo")
    },
    // 币安信息
    {
        meta: {
        ...
        name: "bianInfo",
        component: () =>
            import ( /* webpackChunkName: 'redEnvelopeRain' */ "@/views/activity/bianInfo")
    },
    // 新时代新支付
    {
        meta: {
    ...
    // 皇冠点球成金
    {
        ...
        path: "/activity/dailySportHg",
        name: "dailySportHg",
        component: () =>
            import ("@/views/activity/dailySportHg")
    },
    // 皇冠周末福利赛
    {
        meta: {
        ...
        path: "/activity/weekSportsHg",
        name: "weekSportsHg",
        component: () =>
            import ("@/views/activity/weekSportsHg")
    },
    // 皇冠周周存
    {
        meta: {
        ...
        path: "/activity/weeklySaveHg",
        name: "weeklySaveHg",
        component: () =>
            import ("@/views/activity/weeklySaveHg")
    },
    // 皇冠连赢爆单
    {
        meta: {
        ...
        path: "/activity/streakWinsHg",
        name: "streakWinsHg",
        component: () =>
            import ("@/views/activity/streakWinsHg")
    },
    // 美女派送
    {
        meta: {
    ...
    // 欧洲杯活动
    {
        ...
        path: "/activity/euroCup",
        name: "euroCup",
        component: () =>
            import ("@/views/activity/euroCup")
    },
];
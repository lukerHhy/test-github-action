<template>
  <div class="container quota">
    <lheader :title="title" path="111" :turn.sync="isOpen" :help="walletMoney.open_mode == 1"></lheader>
    <div id="apply">
      <div class="main">
        <div class="accout">
          ...
          <ul>
            ...
            >
              <p>{{item.game_platform_name}}<span v-show="list.to_platform_name !== $t('主账户') && activeIndex == index && !openMoney">({{list.to_platform_name}})</span></p>              
  ...
  methods: {
    ...
    walletM(text) {
      ...
      wallet(this.data).then(res => {
        ...
        console.log('axiba',this.walletList,this.walletMoney,)
      })
      .catch(() => {
        this.$toast.clear()
        this.balanceLoading = false;

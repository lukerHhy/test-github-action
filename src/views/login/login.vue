    ...
    <div class="main" id="home">
      ...
      <div class="function">
        <div class="aagames-button-box funDiv">
          ...
          <div class="right" @click="ForgetPasswordShow = true">{{$t('忘记密码')}}</div>
        </div>
        ...
        <div class="aagames-button-box">
          <van-button class="aagames-button line" @click="quick" type="button">{{$t('无账号？去注册')}}</van-button>
        </div>
      </div>
      <div class="customer">
...
{{$t('专属客服')}}
    ...
    <van-popup get-container="#app" v-model="ForgetPasswordShow" position="bottom">
      <ForgetPassword v-model="ForgetPasswordShow" @hide="ForgetPasswordShow = false"></ForgetPassword>
    </van-popup>
  </div>
</template>

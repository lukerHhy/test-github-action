    ...
    >
      <van-cell v-for="(item, index) in lists" :key="index">
        <div class="event-item" slot="default" @click="onClick(item)">
          ...
          <img class="tags-img" v-if="tagType[item.b_type] && tagType[item.b_type].name == 'VIP'" :src="$imgs['activities/vip']" alt="">
          <img class="tags-img" v-if="tagType[item.b_type] && tagType[item.b_type].name == '新手'" :src="$imgs['activities/xs']" alt="">
          <img class="tags-img" v-if="tagType[item.b_type] && tagType[item.b_type].name == '专题'" :src="$imgs['activities/zt']" alt="">
          <img class="tags-img" v-if="tagType[item.b_type] && tagType[item.b_type].name == '常规'" :src="$imgs['activities/cg']" alt="">
          <img class="tags-img" v-if="tagType[item.b_type] && tagType[item.b_type].name == '限时'" :src="$imgs['activities/limit']" alt="">
          <div class="info">
            <h3>
<!--              <span-->
<!--                v-if="item.b_type"-->
...
<!--              </span>-->
    ...
    <div class="list-empty" v-if="nodata">
      <p>{{$t('我们正在为您准备更多活动哦')}}</p>
    </div>
  </div>
</template>

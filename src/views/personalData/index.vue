    ...
    <div class="reset">
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'':lang==='en'}"> {{$t('昵称')}}</span> </span>
          <input type="text" :placeholder="$t('您未填写昵称')"
          @focus="isShowSave = true" v-model="list.nick_name" />
        </div>
      </div>
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/user.png" />
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('真实姓名')}}</span> </span>
          <input
            type="text"
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('出生日期')}}</span> </span>
          <input
            type="text"
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('微信号')}}</span> </span>
          <input type="text" :placeholder="$t('您未填写微信')"
          @focus="isShowSave = true" v-model="list.wechat" />
        </div>
      </div>
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/qq.png" />
          <span class="pr"> <span :class="{'':lang==='en'}"> {{$t('QQ 号')}}</span> </span>
          <input
            type="text"
            :placeholder="$t('您未填写QQ，立即填写')"
            @focus="isShowSave = true"
            v-model="list.qq"
          />
        </div>
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('手机号')}}</span> </span>
          <input
            type="text"
             :placeholder="$t('立即绑定')"
            readonly
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('邮箱地址')}}</span> </span>
          <input
            type="text"
             :placeholder="$t('立即绑定')"
            readonly
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('登录密码')}}</span> </span>
          <input
            type="text"
            @click="open(1)"
            readonly
      ...
      <div class="aagames-select-box" @click="open(2)">
        <div class="select">
          ...
          <div class="pr"> <div :class="{'':lang==='en'}"> {{$t('资金密码')}}</div> </div>
          <span :class="['input-tips', { red: password == 1 }]">{{
            password == 1
              ? $t('您未设置资金密码')
              : $t('已设置资金密码')
          }}</span>
      ...
      <div class="aagames-select-box mb40" @click="open(3)">
        <div class="select">
          ...
          <span class="pr"> <span :class="{'shrink':lang==='en'}"> {{$t('密保问题')}}</span> </span>
          <span :class="['input-tips', { red: answer === 1 }]">{{
            answer === 1
              ? $t('您未设置密保问题')
              : $t('已设置密保问题')
          }}</span>
      ...
      <div v-show="isShowSave" class="aagames-button-box">
        <button class="aagames-button" type="button" @click="submit">
          {{$t('保存')}}
        </button>
      </div>
    </div>
...
/deep/.van-nav-bar__text{
      transform: scale(0.8) translate(0,-1.2em);

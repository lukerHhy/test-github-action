    ...
    <div class="main">
      <div class="member">
        <div
          class="avatar"
          :style="{
            backgroundImage: `url(${require('@assets/img3_0/memberCenter/login-out.png')})`,
          }"
        ></div>
        <div class="right">
      ...
      <div class="domain">
        ...
        <div
          class="user"
          :style="{
            backgroundImage: `url(${require('@assets/img3_0/agent/agent_bg_info@2x.png')})`,
          }"
        >
          <div class="top">
            <div class="left">
...
{{$t('复制')}}
          ...
          <img
            ...
            :src="require('@assets/img3_0/agent/home/agentqrcode.png')"
            alt=""
          />
        </div>
          ...
          <template v-for="(item, index) in menuList">
            ...
            >
              <img
                ...
                :src="require(`@assets/img3_0/otherIcon/${item.icon}@2x.png`)"
                alt=""
              />
              <p class="text">{{ item.text }}</p>
              <img
                class="more"
                :src="require('@assets/img3_0/otherIcon/more@2x.png')"
                alt=""
              />
            </div>
      ...
      <div class="aagames-button-box">
        <button
          type="button"
          class="aagames-button login-out dark"
          @click="signOut"
        >
{{$t('退出登录')}}
        </button>
    ...
    <van-popup class="domain-dialog" v-model="show">
      <div class="website">
        ...
        <img
          :src="require('@assets/img3_0/agent/home/agentclose.png')"
          class="cross"
          @click="show = false"
          alt=""
        />

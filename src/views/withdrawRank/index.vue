<template>
  <div class="profits-rank">
    ...
    <div class="m-body">
      ...
      <div class="ranks">
        <van-image
          :src="require('@assets/img3_0/memberCenter/ranks@2x.png')"
          fit="cover"
        />
        <ul>
          <li
          ...
          <dl class="item-head">
            <dt>
              ...
              <van-image
                ...
                v-if="$projectname === '10030' || $projectname === '10061'"
                :src="
                  $imgs['vip/level/grade_normal' + (item.level + 1) + '@2x']
                "
              />
              <van-image
                v-else
                :src="
                  require(`@assets/img3_0/vip/level/LV${item.level}@2x.png`)
                "
                fit="cover"
              />
            </dt>

          ...
          <ul class="deposit-main">
            ...
            >
              <div class="board">
                <div class="chips">
                  ...
                  >
                    <label
                      ...
                      :class="{
                        disabledLabel: item * 1 < thirdPayMsg.money * 1,
                      }"
                ...
                <div
                  class="list-cells yt-label"
                  v-if="thirdPayMsg.product_name"
                >
        ...
        >
          ...
          <div class="list-cells" v-show="paymentsChild.length == 0">
            ...
            >
              ...
              <div class="cell-body">
                <div class="cell-flex" style="opacity:1;">
...
{{$t('已完成支付')}}
        ...
        >
          ...
          <div class="pop-body payStatus">
            ...
            <van-image
              class="payStatus-icon"
              :src="$imgs['deposit/bet_icon_charge_fail@2x']"
            ></van-image>
...
{{$t('确认')}}
        ...
        >
          ...
          <div class="pop-body payStatus">
            ...
            <van-image
              class="payStatus-icon"
              :src="$imgs['deposit/bet_icon_charge_success@2x']"
            ></van-image>

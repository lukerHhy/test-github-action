<template>
  <div :style="{zIndex:zIndex}">
    ...
    <div class="aagames-nav-bar">
      ...
      <div class="nav-center">
        <div class="no-token" v-if="!token" style="justify-content: space-between;padding-left: 0">
          <span @click="goLogin">{{$t('未登录')}}</span><span @click="goLogin">{{$t('登录后查看')}}</span>
        </div>
    ...
    <ul class="quick-link">
      <li @click="listPath('deposit')"><img :src="$imgs['home/home_icon_money@2x']" alt=""><span>{{$t('充值')}}</span></li>
      <li @click="listPath('quotaTransfer')"><img :src="$imgs['home/home_icon_transfer@2x']" alt=""><span>{{$t('转账')}}</span></li>
      <li @click="handleWithdraw"><img :src="$imgs['home/home_icon_withdraw@2x']" alt=""><span>{{$t('取款')}}</span></li>

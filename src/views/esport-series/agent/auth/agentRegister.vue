      ...
      <div class="submit-form">
        ...
        <div class="function">
          <div class="aagames-button-box">
            <button type="button" class="aagames-button" @click="register">{{$t('确定')}}</button>
          </div>
        </div>
        <p class="to-login"><span>{{$t('已有账号')}}</span><router-link to="/agentAuth/login"> 登录</router-link></p>
      </div>

...
<template>
  ...
  <div class="aagames-login-header">
    ...
    >
      ...
      <div class="nav-right">
        ...
        <div v-if="kefu">
          ...
          >
            <img
              :src="$imgs['otherIcon/nav_kefu@2x']"
              class="kf-icon"
    ...
    >
      <img
        class="logo"
        :src="$imgs['login/logo@2x']"
        alt=""
      >
      <p
        class="log-tit"
        v-if="$projectname=='10024'||$projectname=='10050'||$projectname=='10022'||$projectname=='10023'||$projectname=='10025'||$projectname=='10060'||$projectname=='10026'||$projectname=='10027'||$projectname=='10028'||$projectname=='10029'||$projectname === '10064'||$projectname==='10059'||$projectname=='10033'||$projectname=='10063'||$projectname==='10043'||$projectname=='10042'"
      >{{$t('官方战略合作')}}</p>
      <img
        class="cooperation"
        v-if="$projectname=='wanqu'||$projectname=='chashao'||$projectname=='10024'||$projectname=='10050'||$projectname=='10022'||$projectname=='10023'||$projectname=='10025'||$projectname=='10060'||$projectname=='10026'||$projectname=='10027'||$projectname=='10028'||$projectname=='10029'||$projectname === '10064'||$projectname==='10059'||$projectname=='10033'||$projectname=='10063'||$projectname==='10043'||$projectname=='10042'"
        :src="$imgs['login/cooperation@2x']"
        alt=""
      >

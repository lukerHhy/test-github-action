...
<template>
  <div class="kfPage" :style="{backgroundImage:$bImgs['common/blue-headbg@2x']}">
          ...
          <div class="kf-slide">
            ...
            <van-collapse v-model="activeNames">
              <van-collapse-item name="1">
                ...
                <router-link to="/help/tutorial" class="kf-ques-more"><span>{{$t('更多问题')}}</span><van-icon name="arrow-down" class="kf-ques-more-icon" /></router-link>
              </van-collapse-item>
              ...
              <van-collapse-item name="3" >
                ...
                <router-link to="/help/manual" class="kf-ques-more"><span>{{$t('更多问题')}}</span><van-icon name="arrow-down" class="kf-ques-more-icon" /></router-link>
              </van-collapse-item>
              ...
              <van-cell  :title="$t('安全保障')" is-link to="/help/tutorial" value="100个常见问题解密">
                <template #title>
                  <div class="kf-slide-tit">
    ...
    <template v-else>
      ...
      <div class="dbkf-slide">
        <van-collapse v-model="activeNames">
          ...
          <van-cell  :title="$t('安全保障')" is-link to="/help/tutorial">
            <template #title>
              <div class="kf-slide-tit">
                <span class="custom-title">{{$t('全部问题')}}</span>
              </div>
    ...
    >
      ...
      <p class="title">{{$t('申请回拨我们将有专人5分钟内给您致电处理问题')}}</p>

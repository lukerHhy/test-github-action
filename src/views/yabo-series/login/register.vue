  ...
  <div class="container regContainer">
    ...
    <div class="bgvideo">
      <!-- <video
          ...
          style="position: fixed;z-index: -1;width: 115%"
      >
    ...
    <div class="main" id="register">
      <div class="register">
        ...
        <div class="fill">
          <div class="aagames-form login-input" v-if="active === 0">
            <div class="input">
          ...
          <template v-if="active === 2">
            <div class="aagames-form login-input">
              <div class="input">
        ...
        <div class="function">
          ...
          <div class="aagames-button-box">
            <van-button v-if="active === 0" :disabled="!(openAccount.account  && openAccount.password && openAccount.againPassword)" :loading="loading" :loading-text="$t('注册中...')" class="aagames-button register" type="button" @click="applySubmitForm">
{{$t('注册')}}
            </van-button>
            <van-button v-else-if="active === 1 " :loading="loading" :loading-text="$t('注册中...')" class="aagames-button register" type="button" @click="applySubmitForm">
{{$t('获取游戏账户')}}
            </van-button>
            <van-button v-else  :disabled="!(mobile  && code)" :loading="loading" :loading-text="$t('注册中...')" class="aagames-button register" type="button" @click="applySubmitForm">
{{$t('注册')}}
            </van-button>
          </div>
          <div class="aagames-button-box">
...
export default {
  ...
  mounted() {
    ...
    console.log()
    if(process.env.VUE_APP_PROJECT_NAME === '10063') {
      this.tab = [this.$t('账号注册')]
    }

      ...
      <div class="home">
        ...
        <div class="function">
          <div class="aagames-button-box funDiv">
            <div class="left rem-pass" @click="togglePass"><van-icon name="circle" v-if="passCheck" /><van-icon v-else name="checked" /><span>{{$t('记住密码')}}</span></div>
          ...
          <div class="aagames-button-box" v-if="active===0">
            <van-button :loading="loading" :loading-text="$t('登录中...')"  :disabled="!(account.username  && account.password)" class="aagames-button sign-in" @click="signIn" type="button">{{$t('登录')}}</van-button>
          </div>
          <div class="aagames-button-box" v-else>
            <van-button :loading="loading" :loading-text="$t('登录中...')"  :disabled="!(phoneSign.phone  && phoneSign.code)" class="aagames-button sign-in" @click="signIn" type="button">{{$t('登录')}}</van-button>
          </div>

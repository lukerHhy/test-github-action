  ...
  <div class="container verify">
    ...
    <div class="main">
        ...
        <div class="aagames-form">
          <div class="input username">
            <img
              ...
              src="../../../assets/loginIcon/user@2x.png"
              alt
            />
            <img
              class="img"
              v-else
              style="margin-right: 6px;"
              :src="$imgs['otherIcon/user@2x']"
              alt
            />
            <input
              type="text"
              v-model="username"
               :placeholder="$t('请输入账户名或手机号')"
            />
          </div>
        </div>
            ...
            <div class="code">
              <div class="input">
                <img
                  ...
                  v-if="aoMenUi.includes($projectname)"
                  style="margin-right: 6px;"
                  src="../../../assets/loginIcon/mbwt@2x.png"
                  alt
                />
                <img
                  class="img"
      ...
      >
        ...
        <div
          v-show="routeType != 'withdraw'"
          class="aagames-button-box"
        >
          <button
            type="button"
            ...
            :disabled="!setPassData.password && !setPassData.repassword && !problem"
            @click="submit"
          >{{$t('完成')}}</button>
        </div>
      </div>
        ...
        if (res.data.code === 0) {
          Toast({
            ...
            onClose() {
              ...
              that.$router.push({ path: "/personalData" });
            }
          });
        } else {
          this.$toast.fail(res.data.msg);

...
export default {
  ...
  data () {
    return {
      title: this.$t('品牌实力'),
      bannerArray:[
        {num:'23',name:this.$t('洛里斯·贝尼托'),eng:'Loris Benito'},
        {num:'03',name:this.$t('巴勃罗·纳西门托·卡斯特罗'),eng:'Pablo Nascimento Castro'},
        {num:'01',name:this.$t('贝诺特·科斯蒂'),eng:'Benoit Costi'},
        {num:'18',name:this.$t('黄义助'),eng:'Ui Jo Hwang'},
        {num:'06',name:this.$t('劳伦特 科斯切尔尼'),eng:'Laurent Koscielny'}],
      activeIndex:0,

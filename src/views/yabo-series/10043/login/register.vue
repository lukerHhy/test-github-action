      ...
      <div class="register">
        ...
        <div class="fill">
          <div class="aagames-form" v-if="active === 0">
            ...
            <div class="input">
              ...
              <input
                type="password"
                v-model="openAccount.againPassword"
                 :placeholder="$t('请确认密码')"
              />
            </div>
          </div>
        ...
        <div class="function">
          <div class="funDiv" align="center">
            ...
            <a @click="showProtocol"
              >《{{ $config[$projectname].secName }}游戏条款》</a
            >
          </div>
            ...
            <van-button
              ...
              :disabled="
                !(
                  ...
                  openAccount.againPassword
                )
              "
              :loading="loading"
              :loading-text="$t('注册中...')"
              class="aagames-button register"
              type="button"
              @click="applySubmitForm"
            >
{{$t('注册')}}
            </van-button>
            <van-button
...
{{$t('专属客服')}}
      ...
      <div class="home-regist-btn" @click="go('/login')">
        <img :src="$imgs['login/bet_login_icon_login@2x']" alt="" /><span
          >{{$t('去登录')}}</span
        >
      </div>
    </div>
...
{{$t('残忍拒绝')}}
            ...
            <button class="aagames-button" type="button" @click="confirmReg">
{{$t('确定')}}
            </button>
          </div>
        </div>

...
export default {
  ...
  methods: {
    ...
    initSwiper() {
      ...
      const actDomArr = document.getElementsByClassName('swiper-pagination-bullet')
        ...
        this.mySwiper1 = new Swiper("#swiper-container1", {
          ...
          on: {
            slideChange: function (e) {
              ...
              console.log('slideChange fired', actDomArr, defDomArr)
              if (this.activeIndex !== 0) {
                // window.scrollTo(0, 0)
                window.scrollTo(0, 1000)
              }

              let actDom = actDomArr[that.activeIdx]
              ...
              for (let i = 0; i < defDomArr.length; i++) {
                if (process.env.VUE_APP_PROJECT_NAME === '10023') {
                  ...
                  defDomArr[i].children[0].classList.remove('scale-up')
                  defDomArr[i].children[0].classList.add('scale-down')
                  defDomArr[i].style.backgroundImage = `url(${that.$imgs['home/bullet']})`
                }
              }
              if (process.env.VUE_APP_PROJECT_NAME === '10023') {
                ...
                actDom.children[0].classList.add('scale-up')
                actDom.children[0].classList.remove('scale-down')
                actDom.style.backgroundImage = `url(${that.$imgs['home/bullet-active']})`
              }
            }
          },
          pagination: {
            ...
            renderBullet: function (index, className) {
              ...
              let bg = that.$imgs['home/bullet']
              that.downAppHidden = window.sessionStorage.getItem('downAppHidden') * 1
              if (process.env.VUE_APP_PROJECT_NAME === '10023' || process.env.VUE_APP_PROJECT_NAME === '10037') {
                var icon = 'none'
              } else {
              ...
              if (that.activeIdx === index) {
                ...
                bg = that.$imgs['home/bullet-active']
                if (process.env.VUE_APP_PROJECT_NAME === '10023' || process.env.VUE_APP_PROJECT_NAME === '10037') {
              ...
              if (process.env.VUE_APP_PROJECT_NAME === '10023' || process.env.VUE_APP_PROJECT_NAME === '10037') {
                ...
                return `<li class="${className}" style="background-image: url(${bg});">
                  <image src="${icon}">
                  <span>${that.navs02[index].title}</span>
                </li>`
              }

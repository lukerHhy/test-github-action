<template>
  <div id="home">
    ...
    >
      ...
      >
        <div
            class="xb-header-logo"
            @click="openSidenav"
        >
          <img
              :src="$imgs['home/bet_home_icon_list@2x']"
              alt=""
          >
        </div>
        <p>{{ $t('西宝娱乐') }}</p>
        <div
            ...
            @click="callService"
        ><img
            :src="$imgs['home/bet_home_icon_kefu@2x']"
            alt=""
        ><span>{{ $t('客服') }}</span></div>
      </div>
      ...
      <tabStyle
          ...
          v-if="$projectname === '10023'||$projectname === '10024'||$projectname === '10050'||$projectname === '10060'||$projectname === '10025'||$projectname === '10026'||$projectname === '10027'||$projectname === '10028'||$projectname === '10029'||$projectname === '10064'||$projectname==='10059'||$projectname === '10033'||$projectname === '10063'||$projectname==='10043'||$projectname==='10042'"
      ></tabStyle>
    ...
    >
      ...
      <div class="leftnav-con">
        <h2>{{ $t('西宝娱乐') }}</h2>
        <p
            class="leftnav-con-item"
            @click="linkTo('/news')"
        ><img
            :src="$imgs['home/icon_sheet_1@2x']"
            alt=""
        ><span>{{ $t('消息中心') }}</span></p>
        <p class="leftnav-con-item"><img
            :src="$imgs['home/icon_sheet_4@2x']"
            alt=""
        ><span>{{ $t('永久域名') }}</span><i
            v-clipboard:copy="`https://${$config[$projectname].domain}`"
            v-clipboard:success="onCopy"
            v-clipboard:error="onError"
        >{{ $config[$projectname].domain }}</i></p>
        <p
            class="leftnav-con-item"
            @click="linkTo('/aboutWe')"
        ><img
            :src="$imgs['home/icon_sheet_5@2x']"
            alt=""
        ><span>{{ $t('关于我们') }}</span></p>
      </div>
      <p
      ...
      <p
          ...
          @click="signOut"
      ><img
          :src="$imgs['home/icon_sheet_out@2x']"
          alt=""
      ><span class="c-999">{{ $t('安全退出') }}</span></p>
    </van-popup>
    <van-dialog
        ...
        showCancelButton
    >
      <p class="bind-card-text">{{ $t('您未绑定银行卡') }}<br/>{{ $t('遇到问题') }}<span
          @click="gokefu"

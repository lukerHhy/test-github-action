    ...
    >
      <van-cell v-for="(item, index) in lists" :key="index">
        ...
        <template v-else>
          ...
          <img
            class="tags-img"
            v-if="tagType[item.b_type] && tagType[item.b_type].name == 'VIP'"
            :src="$imgs['activities/discount_tab1@2x']"
            alt=""
          />
          <img
            class="tags-img"
            v-if="tagType[item.b_type] && tagType[item.b_type].name == '新手'"
            :src="$imgs['activities/discount_tab4@2x']"
            alt=""
          />
          <img
            class="tags-img"
            v-if="tagType[item.b_type] && tagType[item.b_type].name == '专题'"
            :src="$imgs['activities/discount_tab5@2x']"
            alt=""
          />
          <img
            class="tags-img"
            v-if="tagType[item.b_type] && tagType[item.b_type].name == '常规'"
            :src="$imgs['activities/discount_tab3@2x']"
            alt=""
          />
          <img
            class="tags-img"
            v-if="tagType[item.b_type] && tagType[item.b_type].name == '限时'"
            :src="$imgs['activities/discount_tab2@2x']"
            alt=""
          />
        </div>
      </van-cell>

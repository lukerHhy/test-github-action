      ...
      <div class="user-info">
        <div class="person-info">
          ...
          <img
            ...
            :src="$imgs['memberCenter/login-out']"
            alt="login-out"
          />
          <div class="right">
            <div class="top">
              <span
                v-if="userInfo"
                class="name"
                @click="$router.push({ path: '/personalData' })"
                >{{ showName }}</span
              >
              <template v-else>
                <span
            ...
            <div
              ...
              v-if="
                isLogin & ($projectname === '10023') || $projectname === '10033'|| $projectname === '10063'
              "
            >
              <div>
                <span
                  class="bottom-progress-vip"
                  v-if="$projectname === '10033'|| $projectname === '10063'"
              ...
              升级还需<span>{{
                (basicInfo.need_valid_bet && basicInfo.all_valid_bet) ? basicInfo.need_valid_bet - basicInfo.all_valid_bet : '0.00'
              }}</span>
              元 流水
            </div>
          </div>
          ...
          <div class="balance">
            <div class="main-balance">
              ...
              <img
                ...
                @click="refresh"
                :class="{ active: balanceLoading }"
                :src="$imgs['memberCenter/Refresh@2x']"
                alt=""
              />
            </div>
        ...
        <van-row align="center" :gutter="2">
          ...
          >
            <i
              ...
              :style="{
                backgroundImage:
                  $bImgs['memberCenter/list_' + (index + 1) + ''],
              }"
            ></i>
...
export default {
  ...
  mounted() {
    if (['10027', '10033','10063'].includes(process.env.VUE_APP_PROJECT_NAME)) {
      let that = this
